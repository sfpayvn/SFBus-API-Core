...
exports.PosPromotionModule = void 0;
...
const pos_promotion_controller_1 = require("./pos-promotion.controller");
...
let PosPromotionModule = class PosPromotionModule {
};
exports.PosPromotionModule = PosPromotionModule;
exports.PosPromotionModule = PosPromotionModule = __decorate([
    (0, common_1.Module)({
        imports: [
        ...
        providers: [pos_promotion_service_1.PosPromotionService],
        controllers: [pos_promotion_controller_1.PosPromotionController],
        exports: [pos_promotion_service_1.PosPromotionService],
    })
], PosPromotionModule);
//# sourceMappingURL=pos-promotion.module.js.map