...
exports.PosGoodsCategoryService = void 0;
...
let PosGoodsCategoryService = class PosGoodsCategoryService {
    ...
    async create(PosCreateGoodsCategoryDto, tenantId) {
        return this.goodsCategoryService.create(PosCreateGoodsCategoryDto, tenantId);
    }
    async update(PosUpdateGoodsCategoryDto, tenantId) {
...
exports.PosGoodsCategoryService = PosGoodsCategoryService;
exports.PosGoodsCategoryService = PosGoodsCategoryService = __decorate([
...
], PosGoodsCategoryService);
//# sourceMappingURL=pos-goods-category-service.js.map