...
exports.PosPaymentController = void 0;
...
const pos_payment_dto_1 = require("./dto/pos-payment.dto");
const parse_objectId_pipe_1 = require("../../../common/pipes/parse-objectId.pipe");
const roles_constants_1 = require("../../../common/constants/roles.constants");
let PosPaymentController = class PosPaymentController {
    constructor(posPaymentService) {
        this.posPaymentService = posPaymentService;
    }
    processBookingPayment(posRequestPaymentDto, user) {
        const { tenantId, _id } = user;
        return this.posPaymentService.processBookingPayment(posRequestPaymentDto, tenantId, _id);
    }
    processGoodsPayment(posRequestPaymentDto, user) {
        const { tenantId, _id } = user;
...
exports.PosPaymentController = PosPaymentController;
__decorate([
    ...
    __metadata("design:paramtypes", [pos_payment_dto_1.PosRequestPaymentDto,
        user_token_dto_1.UserTokenDto]),
    __metadata("design:returntype", void 0)
], PosPaymentController.prototype, "processBookingPayment", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.POS, roles_constants_1.ROLE_CONSTANTS.ADMIN),
    ...
    __metadata("design:paramtypes", [pos_payment_dto_1.PosRequestPaymentDto,
        user_token_dto_1.UserTokenDto]),
    __metadata("design:returntype", void 0)
], PosPaymentController.prototype, "processGoodsPayment", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.POS, roles_constants_1.ROLE_CONSTANTS.ADMIN),
    ...
    __metadata("design:returntype", void 0)
], PosPaymentController.prototype, "findAllByReferrentId", null);
exports.PosPaymentController = PosPaymentController = __decorate([
    (0, common_1.Controller)('pos/payment'),
    __metadata("design:paramtypes", [pos_payment_service_1.PosPaymentService])
