...
exports.PosSeatTypeController = void 0;
...
const pos_seat_type_dto_1 = require("./dto/pos-seat-type.dto");
...
let PosSeatTypeController = class PosSeatTypeController {
    constructor(PosSeatTypeService) {
        this.PosSeatTypeService = PosSeatTypeService;
    }
...
exports.PosSeatTypeController = PosSeatTypeController;
__decorate([
...
], PosSeatTypeController.prototype, "findOne", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.POS, roles_constants_1.ROLE_CONSTANTS.ADMIN),
    (0, common_1.UseInterceptors)((0, mark_default_tenant_1.MarkDefaultTenant)()),
    ...
    __metadata("design:returntype", void 0)
], PosSeatTypeController.prototype, "findAll", null);
__decorate([
    ...
    __param(1, (0, tenant_scope_1.TenantScope)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [pos_seat_type_dto_1.PosSearchSeatTypesQuery, Object]),
    __metadata("design:returntype", void 0)
], PosSeatTypeController.prototype, "search", null);
exports.PosSeatTypeController = PosSeatTypeController = __decorate([
    (0, common_1.Controller)('pos/seat-types'),
    __metadata("design:paramtypes", [pos_seat_type_service_1.PosSeatTypeService])
], PosSeatTypeController);
//# sourceMappingURL=pos-seat-type.controller.js.map