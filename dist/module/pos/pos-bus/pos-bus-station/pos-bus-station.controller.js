...
exports.PosBusStationController = void 0;
...
const pos_bus_station_dto_1 = require("./dto/pos-bus-station.dto");
...
let PosBusStationController = class PosBusStationController {
    constructor(PosBusStationService) {
        this.PosBusStationService = PosBusStationService;
    }
    findAll(tenantScope) {
...
exports.PosBusStationController = PosBusStationController;
__decorate([
...
], PosBusStationController.prototype, "findAll", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.POS, roles_constants_1.ROLE_CONSTANTS.ADMIN),
    (0, common_1.UseInterceptors)((0, mark_default_tenant_1.MarkDefaultTenant)()),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], PosBusStationController.prototype, "findAllAvailable", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.POS, roles_constants_1.ROLE_CONSTANTS.ADMIN),
    (0, common_1.UseInterceptors)((0, mark_default_tenant_1.MarkDefaultTenant)()),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], PosBusStationController.prototype, "findOffices", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.POS, roles_constants_1.ROLE_CONSTANTS.ADMIN),
    (0, common_1.UseInterceptors)((0, mark_default_tenant_1.MarkDefaultTenant)()),
    ...
    __metadata("design:returntype", void 0)
], PosBusStationController.prototype, "findOne", null);
__decorate([
    ...
    __metadata("design:paramtypes", [mongoose_1.Types.ObjectId, Object]),
    __metadata("design:returntype", void 0)
], PosBusStationController.prototype, "findOneByProvinceId", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, pos_bus_station_dto_1.PosSearchBusStationsQuery]),
    __metadata("design:returntype", void 0)
], PosBusStationController.prototype, "search", null);
exports.PosBusStationController = PosBusStationController = __decorate([
    (0, common_1.Controller)('pos/bus-station'),
    __metadata("design:paramtypes", [pos_bus_station_service_1.PosBusStationService])
], PosBusStationController);
//# sourceMappingURL=pos-bus-station.controller.js.map