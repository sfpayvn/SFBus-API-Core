...
exports.BusServiceController = void 0;
const common_1 = require("@nestjs/common");
const current_user_decorator_1 = require("../../../../decorators/current-user.decorator");
const user_token_dto_1 = require("../../../../jwt/dto/user-token.dto");
const bus_service_service_1 = require("./bus-service.service");
const create_bus_service_dto_1 = require("./dto/create-bus-service.dto");
const update_bus_service_dto_1 = require("./dto/update-bus-service.dto");
...
let BusServiceController = class BusServiceController {
    constructor(busServiceService) {
        this.busServiceService = busServiceService;
    }
    create(createBusServiceDto, user) {
        const { tenantId } = user;
    ...
    update(updateBusServiceDto, user) {
        const { tenantId } = user;
...
exports.BusServiceController = BusServiceController;
__decorate([
    ...
    __metadata("design:paramtypes", [create_bus_service_dto_1.CreateBusServiceDto,
        user_token_dto_1.UserTokenDto]),
    __metadata("design:returntype", void 0)
], BusServiceController.prototype, "create", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.ADMIN),
    ...
    __metadata("design:returntype", void 0)
], BusServiceController.prototype, "findAll", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.ADMIN),
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], BusServiceController.prototype, "findOne", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.ADMIN),
    (0, common_1.Put)(),
    ...
    __param(1, (0, current_user_decorator_1.CurrentUser)(parse_objectId_pipe_1.ParseObjectIdPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [update_bus_service_dto_1.UpdateBusServiceDto,
        user_token_dto_1.UserTokenDto]),
    __metadata("design:returntype", void 0)
], BusServiceController.prototype, "update", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.ADMIN),
    ...
    __metadata("design:paramtypes", [mongoose_1.Types.ObjectId, user_token_dto_1.UserTokenDto]),
    __metadata("design:returntype", void 0)
], BusServiceController.prototype, "delete", null);
__decorate([
    ...
    __param(1, (0, current_user_decorator_1.CurrentUser)(parse_objectId_pipe_1.ParseObjectIdPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [bus_service_dto_1.SearchBusServicesQuery, user_token_dto_1.UserTokenDto]),
    __metadata("design:returntype", void 0)
], BusServiceController.prototype, "search", null);
exports.BusServiceController = BusServiceController = __decorate([
    (0, common_1.Controller)('bus-service'),
    __metadata("design:paramtypes", [bus_service_service_1.BusServiceService])
], BusServiceController);
//# sourceMappingURL=bus-service.controller.js.map