...
export declare class GoodsService {
    ...
    constructor(goodsModel: Model<GoodsDocument>, busScheduleService: BusScheduleService, goodsCategoryService: GoodsCategoryService, fileService: FileService, paymentService: PaymentService, goodsGateway: GoodsGateway);
