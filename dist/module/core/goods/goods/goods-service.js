...
let GoodsService = class GoodsService {
    constructor(goodsModel, busScheduleService, goodsCategoryService, fileService, paymentService, goodsGateway) {
...
exports.GoodsService = GoodsService = __decorate([
    ...
    __param(2, (0, common_1.Inject)((0, common_1.forwardRef)(() => goods_category_service_1.GoodsCategoryService))),
    __param(3, (0, common_1.Inject)((0, common_1.forwardRef)(() => file_service_1.FileService))),
