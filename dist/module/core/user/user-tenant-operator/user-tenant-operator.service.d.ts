...
export declare class UserTenantOperatorService {
    private userModel;
    private readonly userService;
    constructor(userModel: Model<UserDocument>, userService: UserService);
    create(adminCreateUserDto: CreateUserDto, tenantId?: Types.ObjectId): Promise<UserDto>;
    update(adminUpdateUserProfileDto: UpdateUserProfileDto, tenantId: Types.ObjectId): Promise<UserDto>;
    updateUserField(userId: Types.ObjectId, fieldName: string, value: any, tenantId: Types.ObjectId): Promise<UserDto>;
    updatePassword(userId: Types.ObjectId, adminUpdatePasswordUserDto: UpdatePasswordUserDto, tenantId: Types.ObjectId): Promise<UserDto>;
