...
exports.UserTenantOperatorService = void 0;
...
let UserTenantOperatorService = class UserTenantOperatorService {
    constructor(userModel, userService) {
        this.userModel = userModel;
        this.userService = userService;
    }
    async create(adminCreateUserDto, tenantId) {
        adminCreateUserDto.roles = [roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR];
    ...
    async search(pageIdx, pageSize, keyword, sortBy, filters, tenantId) {
        ...
        if (matchStageIndex !== -1) {
            pipeline[matchStageIndex].$match = {
                ...pipeline[matchStageIndex].$match,
                roles: { $in: [roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR] },
            };
        }
        else {
            pipeline.unshift({
                $match: { roles: { $in: [roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR] } },
            });
        }
...
exports.UserTenantOperatorService = UserTenantOperatorService;
exports.UserTenantOperatorService = UserTenantOperatorService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(user_schema_1.UserDocument.name)),
    __metadata("design:paramtypes", [mongoose_2.Model,
        user_service_1.UserService])
], UserTenantOperatorService);
//# sourceMappingURL=user-tenant-operator.service.js.map