...
exports.AdminBusScheduleAutogeneratorService = void 0;
...
let AdminBusScheduleAutogeneratorService = class AdminBusScheduleAutogeneratorService {
    ...
    async create(adminCreateBusScheduleAutogeneratorDto, tenantId, timezoneOffset) {
        return this.busScheduleAutogeneratorService.create(adminCreateBusScheduleAutogeneratorDto, tenantId, timezoneOffset);
    }
    async update(adminUpdateBusScheduleAutogeneratorDto, tenantId, timezoneOffset) {
        return this.busScheduleAutogeneratorService.update(adminUpdateBusScheduleAutogeneratorDto, tenantId, timezoneOffset);
    }
    ...
    async runCreateBusSchedule(_id, rootTenantId, tenantId) {
...
exports.AdminBusScheduleAutogeneratorService = AdminBusScheduleAutogeneratorService;
exports.AdminBusScheduleAutogeneratorService = AdminBusScheduleAutogeneratorService = __decorate([
...
], AdminBusScheduleAutogeneratorService);
//# sourceMappingURL=admin-bus-schedule-autogenerator.service.js.map