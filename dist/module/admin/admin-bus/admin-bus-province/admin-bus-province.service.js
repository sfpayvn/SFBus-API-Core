...
exports.AdminBusProvinceService = void 0;
...
let AdminBusProvinceService = class AdminBusProvinceService {
    ...
    async create(adminCreateBusProvinceDto, tenantId) {
        return this.busProvinceService.create(adminCreateBusProvinceDto, tenantId);
    }
    async clone(adminCloneBusProvinceDto, tenantId) {
...
exports.AdminBusProvinceService = AdminBusProvinceService;
exports.AdminBusProvinceService = AdminBusProvinceService = __decorate([
...
], AdminBusProvinceService);
//# sourceMappingURL=admin-bus-province.service.js.map