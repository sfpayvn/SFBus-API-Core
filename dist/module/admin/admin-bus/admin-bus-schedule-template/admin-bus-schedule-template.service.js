...
exports.AdminBusScheduleTemplateService = void 0;
...
const bus_schedule_template_service_1 = require("../../../core/bus/bus-schedule-template/bus-schedule-template.service");
let AdminBusScheduleTemplateService = class AdminBusScheduleTemplateService {
    constructor(BusScheduleTemplateModel, busScheduleTemplateService) {
    ...
    async create(adminCreateBusScheduleTemplateDto, tenantId) {
        return this.busScheduleTemplateService.create(adminCreateBusScheduleTemplateDto, tenantId);
    }
    update(adminUpdateBusScheduleTemplateDto, tenantId) {
...
exports.AdminBusScheduleTemplateService = AdminBusScheduleTemplateService;
exports.AdminBusScheduleTemplateService = AdminBusScheduleTemplateService = __decorate([
...
], AdminBusScheduleTemplateService);
//# sourceMappingURL=admin-bus-schedule-template.service.js.map