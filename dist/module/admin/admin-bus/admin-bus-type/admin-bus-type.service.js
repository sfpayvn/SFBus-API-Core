...
exports.AdminBusTypeService = void 0;
...
let AdminBusTypeService = class AdminBusTypeService {
    ...
    async create(adminCreateBusTypeDto, tenantId) {
        return this.busTypeService.create(adminCreateBusTypeDto, tenantId);
    }
    async update(adminUpdateBusTypeDto, tenantId) {
...
exports.AdminBusTypeService = AdminBusTypeService;
exports.AdminBusTypeService = AdminBusTypeService = __decorate([
...
//# sourceMappingURL=admin-bus-type.service.js.map