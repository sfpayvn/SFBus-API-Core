...
exports.AdminBusScheduleLayoutService = void 0;
...
let AdminBusScheduleLayoutService = class AdminBusScheduleLayoutService {
    ...
    async create(adminCreateBusScheduleLayoutDto, tenantId) {
        return this.busScheduleLayoutService.create(adminCreateBusScheduleLayoutDto, tenantId);
    }
    async update(adminUpdateBusScheduleLayoutDto, tenantId) {
...
exports.AdminBusScheduleLayoutService = AdminBusScheduleLayoutService;
exports.AdminBusScheduleLayoutService = AdminBusScheduleLayoutService = __decorate([
...
], AdminBusScheduleLayoutService);
//# sourceMappingURL=admin-bus-schedule-layout.service.js.map