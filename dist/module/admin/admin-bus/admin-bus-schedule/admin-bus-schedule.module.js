...
exports.AdminBusScheduleModule = void 0;
const bus_schedule_schema_1 = require("../../../core/bus/bus-schedule/schema/bus-schedule.schema");
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const admin_bus_schedule_controller_1 = require("./admin-bus-schedule.controller");
...
let AdminBusScheduleModule = class AdminBusScheduleModule {
};
exports.AdminBusScheduleModule = AdminBusScheduleModule;
exports.AdminBusScheduleModule = AdminBusScheduleModule = __decorate([
    (0, common_1.Module)({
        imports: [
        ...
        controllers: [admin_bus_schedule_controller_1.AdminBusScheduleController],
        providers: [admin_bus_schedule_service_1.AdminBusScheduleService],
        exports: [admin_bus_schedule_service_1.AdminBusScheduleService],
    })
], AdminBusScheduleModule);
//# sourceMappingURL=admin-bus-schedule.module.js.map