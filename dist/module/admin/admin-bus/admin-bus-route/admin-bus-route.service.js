...
exports.AdminBusRouteService = void 0;
...
let AdminBusRouteService = class AdminBusRouteService {
    ...
    async create(adminCreateBusRouteDto, tenantId) {
    ...
    async update(adminUpdateBusRouteDto, tenantId) {
...
exports.AdminBusRouteService = AdminBusRouteService;
exports.AdminBusRouteService = AdminBusRouteService = __decorate([
...
], AdminBusRouteService);
//# sourceMappingURL=admin-bus-route.service.js.map