...
exports.AdminTrackingService = void 0;
const common_1 = require("@nestjs/common");
const tracking_service_1 = require("../../core/tracking/tracking.service");
const roles_constants_1 = require("../../../common/constants/roles.constants");
let AdminTrackingService = class AdminTrackingService {
    constructor(trackingService) {
        this.trackingService = trackingService;
    }
    async create(createTrackingDto, tenantId) {
        return this.trackingService.create({ ...createTrackingDto, platform: roles_constants_1.ROLE_CONSTANTS.ADMIN }, tenantId);
    }
...
exports.AdminTrackingService = AdminTrackingService;
exports.AdminTrackingService = AdminTrackingService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [tracking_service_1.TrackingService])
], AdminTrackingService);
//# sourceMappingURL=admin-tracking.service.js.map