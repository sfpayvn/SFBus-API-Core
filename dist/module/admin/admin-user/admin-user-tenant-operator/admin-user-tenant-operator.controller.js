...
exports.AdminUserTenantOperatorController = void 0;
...
const module_function_keys_2 = require("../../../../common/constants/module-function-keys");
...
let AdminUserTenantOperatorController = class AdminUserTenantOperatorController {
    constructor(adminUserTenantOperatorService) {
        this.adminUserTenantOperatorService = adminUserTenantOperatorService;
    }
...
exports.AdminUserTenantOperatorController = AdminUserTenantOperatorController;
__decorate([
    ...
    (0, feature_decorator_1.Feature)(module_function_keys_1.MODULE_KEYS.USER_TENANT_OPERATOR, module_function_keys_2.FUNCTION_KEYS.USER_TENANT_OPERATOR.CREATE),
...
], AdminUserTenantOperatorController.prototype, "register", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AdminUserTenantOperatorController.prototype, "updateProfile", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, common_1.UseInterceptors)((0, strip_fields_interceptor_1.StripFields)(['password'])),
    ...
    __metadata("design:returntype", Promise)
], AdminUserTenantOperatorController.prototype, "setPasswordAsTemp", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard, quota_guard_1.QuotaGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.ADMIN, roles_constants_1.ROLE_CONSTANTS.TENANT, roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR),
    (0, common_1.UseInterceptors)(quota_headers_interceptor_1.QuotaHeadersInterceptor),
    (0, feature_decorator_1.Feature)(module_function_keys_1.MODULE_KEYS.USER_TENANT_OPERATOR, module_function_keys_2.FUNCTION_KEYS.USER_TENANT_OPERATOR.CREATE, module_function_keys_1.ACTIONQUOTA_KEYS.RELEASED),
...
], AdminUserTenantOperatorController.prototype, "delete", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AdminUserTenantOperatorController.prototype, "search", null);
exports.AdminUserTenantOperatorController = AdminUserTenantOperatorController = __decorate([
    (0, common_1.Controller)('admin/users/tenant-operator'),
    __metadata("design:paramtypes", [admin_user_tenant_operator_service_1.AdminUserTenantOperatorService])
], AdminUserTenantOperatorController);
//# sourceMappingURL=admin-user-tenant-operator.controller.js.map