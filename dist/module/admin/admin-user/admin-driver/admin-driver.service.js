...
exports.AdminDriverService = void 0;
...
let AdminDriverService = class AdminDriverService {
    constructor(driverModel, driverService) {
        this.driverModel = driverModel;
        this.driverService = driverService;
    }
    async create(adminCreateDriverDto, tenantId) {
        return this.driverService.create(adminCreateDriverDto, tenantId);
    }
    async update(adminUpdateDriverDto, tenantId) {
...
exports.AdminDriverService = AdminDriverService;
exports.AdminDriverService = AdminDriverService = __decorate([
...
//# sourceMappingURL=admin-driver.service.js.map