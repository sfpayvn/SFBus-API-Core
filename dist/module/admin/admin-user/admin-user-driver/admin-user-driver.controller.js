...
exports.AdminUserDriverController = void 0;
...
let AdminUserDriverController = class AdminUserDriverController {
    constructor(adminUserDriverService) {
        this.adminUserDriverService = adminUserDriverService;
    }
    async register(adminCreateUserDto, cUser) {
        try {
            const { tenantId } = cUser;
            return await this.adminUserDriverService.create(adminCreateUserDto, tenantId);
        }
        catch (error) {
    ...
    async updateProfile(user, adminUpdateUserProfileDto) {
        try {
            const { tenantId } = user;
            const updatedUser = await this.adminUserDriverService.update(adminUpdateUserProfileDto, tenantId);
            return updatedUser;
        }
        catch (error) {
            throw new common_1.BadRequestException(error.message);
    ...
    async setPasswordAsTemp(userId, body, user) {
        ...
        return this.adminUserDriverService.setPasswordAsTemp(userId, newPassword, tenantId);
    }
    delete(id, user) {
        return this.adminUserDriverService.delete(id);
    }
    search(query, user) {
        const { pageIdx = 0, pageSize = 0, keyword = '', sortBy, filters } = query;
        const { tenantId } = user;
        return this.adminUserDriverService.search(+pageIdx, +pageSize, keyword, sortBy, filters, tenantId);
    }
};
exports.AdminUserDriverController = AdminUserDriverController;
__decorate([
    ...
    (0, feature_decorator_1.Feature)(module_function_keys_1.MODULE_KEYS.USER_DRIVER, module_function_keys_1.FUNCTION_KEYS.USER_DRIVER.CREATE),
...
], AdminUserDriverController.prototype, "register", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AdminUserDriverController.prototype, "updateProfile", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, common_1.UseInterceptors)((0, strip_fields_interceptor_1.StripFields)(['password'])),
    ...
    __metadata("design:returntype", Promise)
], AdminUserDriverController.prototype, "setPasswordAsTemp", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard, quota_guard_1.QuotaGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.ADMIN, roles_constants_1.ROLE_CONSTANTS.TENANT, roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR),
    (0, common_1.UseInterceptors)(quota_headers_interceptor_1.QuotaHeadersInterceptor),
    (0, feature_decorator_1.Feature)(module_function_keys_1.MODULE_KEYS.USER_DRIVER, module_function_keys_1.FUNCTION_KEYS.USER_DRIVER.CREATE, module_function_keys_1.ACTIONQUOTA_KEYS.RELEASED),
...
], AdminUserDriverController.prototype, "delete", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AdminUserDriverController.prototype, "search", null);
exports.AdminUserDriverController = AdminUserDriverController = __decorate([
    (0, common_1.Controller)('admin/users/driver'),
    __metadata("design:paramtypes", [admin_user_driver_service_1.AdminUserDriverService])
], AdminUserDriverController);
//# sourceMappingURL=admin-user-driver.controller.js.map