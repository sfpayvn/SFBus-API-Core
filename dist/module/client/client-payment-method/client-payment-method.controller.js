...
exports.ClientPaymentMethodController = void 0;
...
const client_payment_method_service_1 = require("./client-payment-method-service");
...
let ClientPaymentMethodController = class ClientPaymentMethodController {
    constructor(clientPaymentMethodService) {
        this.clientPaymentMethodService = clientPaymentMethodService;
    }
...
exports.ClientPaymentMethodController = ClientPaymentMethodController;
__decorate([
...
], ClientPaymentMethodController.prototype, "findOne", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.ADMIN, roles_constants_1.ROLE_CONSTANTS.CLIENT, roles_constants_1.ROLE_CONSTANTS.TENANT, roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR, roles_constants_1.ROLE_CONSTANTS.POS, roles_constants_1.ROLE_CONSTANTS.DRIVER),
    (0, common_1.UseInterceptors)((0, mark_default_tenant_1.MarkDefaultTenant)()),
    ...
    __metadata("design:returntype", void 0)
], ClientPaymentMethodController.prototype, "findAll", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.ADMIN, roles_constants_1.ROLE_CONSTANTS.CLIENT, roles_constants_1.ROLE_CONSTANTS.TENANT, roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR, roles_constants_1.ROLE_CONSTANTS.POS, roles_constants_1.ROLE_CONSTANTS.DRIVER),
    (0, common_1.UseInterceptors)((0, mark_default_tenant_1.MarkDefaultTenant)()),
...
], ClientPaymentMethodController.prototype, "findDefault", null);
exports.ClientPaymentMethodController = ClientPaymentMethodController = __decorate([
    (0, common_1.Controller)('client/payment-method'),
    __metadata("design:paramtypes", [client_payment_method_service_1.ClientPaymentMethodService])
], ClientPaymentMethodController);
//# sourceMappingURL=client-payment-method.controller.js.map