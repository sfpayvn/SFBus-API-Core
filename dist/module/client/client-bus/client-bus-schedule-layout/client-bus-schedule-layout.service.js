...
exports.ClientBusScheduleLayoutService = void 0;
...
const client_bus_schedule_layout_dto_1 = require("./dto/client-bus-schedule-layout.dto");
let ClientBusScheduleLayoutService = class ClientBusScheduleLayoutService {
    ...
    async findOneByBusSchedule(busScheduleId, tenantId) {
        ...
        if (!layout) {
            throw new common_1.BadRequestException('không tìm thấy bố cục cho lịch trình xe buýt này');
        }
        layout.seatLayouts.map((seatLayout) => {
            return seatLayout.seats.map((seat) => {
                if (seat.bookingId) {
                    seat.status = 'blocked';
                }
            });
        });
        return (0, class_transformer_1.plainToInstance)(client_bus_schedule_layout_dto_1.ClientBusScheduleLayoutDto, layout, {});
    }
};
exports.ClientBusScheduleLayoutService = ClientBusScheduleLayoutService;
exports.ClientBusScheduleLayoutService = ClientBusScheduleLayoutService = __decorate([
...
], ClientBusScheduleLayoutService);
//# sourceMappingURL=client-bus-schedule-layout.service.js.map