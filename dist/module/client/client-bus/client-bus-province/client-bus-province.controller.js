...
exports.ClientBusProvinceController = void 0;
...
const client_bus_province_dto_1 = require("./dto/client-bus-province.dto");
...
let ClientBusProvinceController = class ClientBusProvinceController {
    constructor(ClientBusProvinceService) {
        this.ClientBusProvinceService = ClientBusProvinceService;
    }
    findAll(tenantScope) {
...
exports.ClientBusProvinceController = ClientBusProvinceController;
__decorate([
...
], ClientBusProvinceController.prototype, "findAll", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.ADMIN, roles_constants_1.ROLE_CONSTANTS.CLIENT, roles_constants_1.ROLE_CONSTANTS.TENANT, roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR, roles_constants_1.ROLE_CONSTANTS.POS, roles_constants_1.ROLE_CONSTANTS.DRIVER),
    (0, common_1.UseInterceptors)((0, mark_default_tenant_1.MarkDefaultTenant)()),
    ...
    __metadata("design:returntype", void 0)
], ClientBusProvinceController.prototype, "findOne", null);
__decorate([
    ...
    __param(1, (0, tenant_scope_1.TenantScope)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [client_bus_province_dto_1.ClientSearchBusProvincesQuery, Object]),
    __metadata("design:returntype", void 0)
], ClientBusProvinceController.prototype, "search", null);
exports.ClientBusProvinceController = ClientBusProvinceController = __decorate([
    (0, common_1.Controller)('client/bus-province'),
    __metadata("design:paramtypes", [client_bus_province_service_1.ClientBusProvinceService])
], ClientBusProvinceController);
//# sourceMappingURL=client-bus-province.controller.js.map