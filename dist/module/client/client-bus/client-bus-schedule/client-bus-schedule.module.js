...
exports.ClientBusScheduleModule = void 0;
const bus_schedule_schema_1 = require("../../../core/bus/bus-schedule/schema/bus-schedule.schema");
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const client_bus_schedule_controller_1 = require("./client-bus-schedule.controller");
...
let ClientBusScheduleModule = class ClientBusScheduleModule {
};
exports.ClientBusScheduleModule = ClientBusScheduleModule;
exports.ClientBusScheduleModule = ClientBusScheduleModule = __decorate([
    (0, common_1.Module)({
        imports: [
        ...
        controllers: [client_bus_schedule_controller_1.ClientBusScheduleController],
        providers: [client_bus_schedule_service_1.ClientBusScheduleService],
        exports: [client_bus_schedule_service_1.ClientBusScheduleService],
    })
], ClientBusScheduleModule);
//# sourceMappingURL=client-bus-schedule.module.js.map