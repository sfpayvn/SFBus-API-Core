...
exports.ClientBusLayoutTemplateController = void 0;
...
const client_bus_layout_template_dto_1 = require("./dto/client-bus-layout-template.dto");
...
let ClientBusLayoutTemplateController = class ClientBusLayoutTemplateController {
    constructor(ClientBusLayoutTemplateService) {
        this.ClientBusLayoutTemplateService = ClientBusLayoutTemplateService;
    }
...
exports.ClientBusLayoutTemplateController = ClientBusLayoutTemplateController;
__decorate([
...
], ClientBusLayoutTemplateController.prototype, "findAll", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, common_1.UseInterceptors)((0, mark_default_tenant_1.MarkDefaultTenant)()),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.ADMIN, roles_constants_1.ROLE_CONSTANTS.CLIENT, roles_constants_1.ROLE_CONSTANTS.TENANT, roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR, roles_constants_1.ROLE_CONSTANTS.POS, roles_constants_1.ROLE_CONSTANTS.DRIVER),
    ...
    __metadata("design:returntype", Promise)
], ClientBusLayoutTemplateController.prototype, "findOne", null);
__decorate([
    ...
    __param(1, (0, tenant_scope_1.TenantScope)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [client_bus_layout_template_dto_1.ClientSearchBusLayoutTemplateQuery, Object]),
    __metadata("design:returntype", void 0)
], ClientBusLayoutTemplateController.prototype, "search", null);
exports.ClientBusLayoutTemplateController = ClientBusLayoutTemplateController = __decorate([
    (0, common_1.Controller)('client/bus-layout-templates'),
    __metadata("design:paramtypes", [client_bus_layout_template_service_1.ClientBusLayoutTemplateService])
], ClientBusLayoutTemplateController);
//# sourceMappingURL=client-bus-layout-template.controller.js.map