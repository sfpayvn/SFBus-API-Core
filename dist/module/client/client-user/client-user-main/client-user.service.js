...
let ClientUserService = class ClientUserService {
    ...
    async create(ClientCreateUserDto, tenantId) {
        return this.userService.create(ClientCreateUserDto, tenantId);
    }
    async updateUserProfile(clientUpdateUserProfileDto, tenantId) {
    ...
    markIdentifierAsVerified(userId, tenantId, identifier) {
