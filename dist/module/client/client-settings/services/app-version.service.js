...
exports.ClientAppVersionService = void 0;
const common_1 = require("@nestjs/common");
const settings_service_1 = require("../../../core/settings/settings.service");
const utils_1 = require("../../../../utils/utils");
let ClientAppVersionService = class ClientAppVersionService {
    ...
    async getAppVersionForTenant(tenantId) {
        return this.settingsService.getAppVersion(tenantId);
    }
};
exports.ClientAppVersionService = ClientAppVersionService;
exports.ClientAppVersionService = ClientAppVersionService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [settings_service_1.SettingsService])
], ClientAppVersionService);
