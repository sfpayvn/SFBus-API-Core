...
exports.DriverPaymentMethodController = void 0;
...
let DriverPaymentMethodController = class DriverPaymentMethodController {
    constructor(driverPaymentMethodService) {
        this.driverPaymentMethodService = driverPaymentMethodService;
    }
...
exports.DriverPaymentMethodController = DriverPaymentMethodController;
__decorate([
...
], DriverPaymentMethodController.prototype, "findOne", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.DRIVER, roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR, roles_constants_1.ROLE_CONSTANTS.TENANT, roles_constants_1.ROLE_CONSTANTS.ADMIN, roles_constants_1.ROLE_CONSTANTS.POS),
    (0, common_1.UseInterceptors)((0, mark_default_tenant_1.MarkDefaultTenant)()),
    ...
    __metadata("design:returntype", void 0)
], DriverPaymentMethodController.prototype, "findAll", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.DRIVER, roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR, roles_constants_1.ROLE_CONSTANTS.TENANT, roles_constants_1.ROLE_CONSTANTS.ADMIN, roles_constants_1.ROLE_CONSTANTS.POS),
    (0, common_1.UseInterceptors)((0, mark_default_tenant_1.MarkDefaultTenant)()),
...
], DriverPaymentMethodController.prototype, "findDefault", null);
exports.DriverPaymentMethodController = DriverPaymentMethodController = __decorate([
    (0, common_1.Controller)('driver/payment-method'),
    __metadata("design:paramtypes", [driver_payment_method_service_1.DriverPaymentMethodService])
], DriverPaymentMethodController);
//# sourceMappingURL=driver-payment-method.controller.js.map