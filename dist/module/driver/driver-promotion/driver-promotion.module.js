...
exports.DriverPromotionModule = void 0;
...
const driver_promotion_controller_1 = require("./driver-promotion.controller");
...
let DriverPromotionModule = class DriverPromotionModule {
};
exports.DriverPromotionModule = DriverPromotionModule;
exports.DriverPromotionModule = DriverPromotionModule = __decorate([
    (0, common_1.Module)({
        imports: [
        ...
        providers: [driver_promotion_service_1.DriverPromotionService],
        controllers: [driver_promotion_controller_1.DriverPromotionController],
        exports: [driver_promotion_service_1.DriverPromotionService],
    })
], DriverPromotionModule);
//# sourceMappingURL=driver-promotion.module.js.map