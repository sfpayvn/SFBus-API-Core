...
let DriverTrackingService = class DriverTrackingService {
    constructor(trackingService) {
        this.trackingService = trackingService;
    }
    async create(createTrackingDto, tenantId) {
        return this.trackingService.create({ ...createTrackingDto, platform: roles_constants_1.ROLE_CONSTANTS.DRIVER }, tenantId);
    }
...
exports.DriverTrackingService = DriverTrackingService;
exports.DriverTrackingService = DriverTrackingService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [tracking_service_1.TrackingService])
], DriverTrackingService);
//# sourceMappingURL=driver-tracking.service.js.map