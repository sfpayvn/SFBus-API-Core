...
exports.DriverBusTypeController = void 0;
...
const driver_bus_type_dto_1 = require("./dto/driver-bus-type.dto");
...
let DriverBusTypeController = class DriverBusTypeController {
    constructor(DriverBusTypeService) {
        this.DriverBusTypeService = DriverBusTypeService;
    }
...
exports.DriverBusTypeController = DriverBusTypeController;
__decorate([
...
], DriverBusTypeController.prototype, "findOne", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.DRIVER, roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR, roles_constants_1.ROLE_CONSTANTS.TENANT, roles_constants_1.ROLE_CONSTANTS.ADMIN, roles_constants_1.ROLE_CONSTANTS.POS),
    ...
    __metadata("design:returntype", void 0)
], DriverBusTypeController.prototype, "findAll", null);
__decorate([
    ...
    __param(1, (0, tenant_scope_1.TenantScope)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [driver_bus_type_dto_1.DriverSearchBusTypesQuery, Object]),
    __metadata("design:returntype", void 0)
], DriverBusTypeController.prototype, "search", null);
exports.DriverBusTypeController = DriverBusTypeController = __decorate([
    (0, common_1.Controller)('driver/bus-type'),
    __metadata("design:paramtypes", [driver_bus_type_service_1.DriverBusTypeService])
], DriverBusTypeController);
//# sourceMappingURL=driver-bus-type.controller.js.map