...
exports.DriverDriverController = void 0;
...
const driver_update_driver_dto_1 = require("./dto/driver-update-driver.dto");
const roles_constants_1 = require("../../../../common/constants/roles.constants");
let DriverDriverController = class DriverDriverController {
    constructor(DriverDriverService) {
        this.DriverDriverService = DriverDriverService;
    }
    update(DriverUpdateDriverDto, user) {
...
exports.DriverDriverController = DriverDriverController;
__decorate([
    ...
    __metadata("design:paramtypes", [driver_update_driver_dto_1.DriverUpdateDriverDto,
        user_token_dto_1.UserTokenDto]),
    __metadata("design:returntype", void 0)
], DriverDriverController.prototype, "update", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.DRIVER, roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR, roles_constants_1.ROLE_CONSTANTS.TENANT, roles_constants_1.ROLE_CONSTANTS.ADMIN, roles_constants_1.ROLE_CONSTANTS.POS),
    ...
    __metadata("design:returntype", void 0)
], DriverDriverController.prototype, "findOne", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.DRIVER, roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR, roles_constants_1.ROLE_CONSTANTS.TENANT, roles_constants_1.ROLE_CONSTANTS.ADMIN, roles_constants_1.ROLE_CONSTANTS.POS),
    ...
    __metadata("design:paramtypes", [mongoose_1.Types.ObjectId, user_token_dto_1.UserTokenDto]),
    __metadata("design:returntype", void 0)
], DriverDriverController.prototype, "findOneByUser", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_constants_1.ROLE_CONSTANTS.DRIVER, roles_constants_1.ROLE_CONSTANTS.TENANT_OPERATOR, roles_constants_1.ROLE_CONSTANTS.TENANT, roles_constants_1.ROLE_CONSTANTS.ADMIN, roles_constants_1.ROLE_CONSTANTS.POS),
    ...
    __metadata("design:returntype", void 0)
], DriverDriverController.prototype, "findAllUserDriver", null);
exports.DriverDriverController = DriverDriverController = __decorate([
    (0, common_1.Controller)('driver/drivers'),
    __metadata("design:paramtypes", [driver_driver_service_1.DriverDriverService])
], DriverDriverController);
//# sourceMappingURL=driver-driver.controller.js.map