...
export class DriverRequestUpdateGoodsBoardingDto {
  @IsNotEmpty()
  @IsIn([GOODS_STATUS.PENDING, GOODS_STATUS.ON_BOARD, GOODS_STATUS.ARRIVED_FINAL_STATION, GOODS_STATUS.COMPLETED, GOODS_STATUS.OUT_FOR_DELIVERY, GOODS_STATUS.WAITING_CONTINUE_DELIVERY])
  status: string;
