...
export class AdminGoodsEvent {
  ...
  @Expose()
  stationId?: Types.ObjectId; // station liên quan (drop/nh?n/...)
...
export class AdminGoodsDto {
  ...
  @Expose()
  currentStationId?: Types.ObjectId; // station hi?n t?i dang gi? hàng (null khi ON_BOARD)
  ...
  @Expose()
  deliveryAddress?: string; // n?u giao t?n nhà
