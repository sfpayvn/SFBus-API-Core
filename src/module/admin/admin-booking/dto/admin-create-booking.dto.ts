...
export class AdminCreateBookingItemSeatDto {
  _id: Types.ObjectId;
...
export class AdminCreateBookingItemDto {
  _id: Types.ObjectId;
  ...
  @IsNotEmpty()
  @ValidateNested()
  @Type(() => AdminCreateBookingItemSeatDto)
...
export class AdminCreateBookingUserInforDto {
  @IsNotEmpty()
  @Type(() => String)
  name: string;
...
export class AdminCreateBookingDto {
  ...
  @IsNotEmpty()
  @ValidateNested()
  @Type(() => AdminCreateBookingUserInforDto)
  ...
  @Type(() => AdminCreateBookingItemDto)
