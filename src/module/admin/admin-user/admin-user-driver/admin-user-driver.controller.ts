...
@Controller('admin/users/driver')
export class AdminUserDriverController {
  constructor(private adminUserDriverService: AdminUserDriverService) {}
  ...
  @Post('register')
  @Feature(MODULE_KEYS.USER_DRIVER, FUNCTION_KEYS.USER_DRIVER.CREATE)
  async register(
  ...
  @Feature(MODULE_KEYS.USER_DRIVER, FUNCTION_KEYS.USER_DRIVER.CREATE, ACTIONQUOTA_KEYS.RELEASED)
  @Delete(':id')
