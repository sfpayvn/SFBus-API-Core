...
import { ClientPromotionController } from './client-promotion.controller';
...
@Module({
  ...
  providers: [ClientPromotionService],
  controllers: [ClientPromotionController],
  exports: [ClientPromotionService],
})
export class ClientPromotionModule {}
