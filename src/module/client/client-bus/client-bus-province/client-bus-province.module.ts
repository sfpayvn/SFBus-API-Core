...
import { ClientBusProvinceController } from './client-bus-province.controller';
...
@Module({
  ...
  controllers: [ClientBusProvinceController],
  providers: [ClientBusProvinceService],
  exports: [ClientBusProvinceService],
})
export class ClientBusProvinceModule {}
