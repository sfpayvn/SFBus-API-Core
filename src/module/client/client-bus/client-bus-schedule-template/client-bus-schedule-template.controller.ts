...
@Controller('client/bus-schedule_templates')
export class ClientBusScheduleTemplateController {
  constructor(private readonly ClientBusScheduleTemplateService: ClientBusScheduleTemplateService) {}
  ...
  @Post('search')
  async search(
    @Body(ParseObjectIdPipe) query: ClientSearchBusScheduleTemplateQuery,
