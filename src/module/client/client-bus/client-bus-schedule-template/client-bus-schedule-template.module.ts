...
import { ClientBusScheduleTemplateController } from './client-bus-schedule-template.controller';
...
@Module({
  ...
  controllers: [ClientBusScheduleTemplateController],
  providers: [ClientBusScheduleTemplateService],
  exports: [ClientBusScheduleTemplateService],
})
export class ClientBusScheduleTemplateModule {}
